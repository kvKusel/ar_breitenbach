...
Shader "Custom/ShadowReceiverBiRP"
{
    ...
    SubShader {
        Pass {
            ...
            Tags { "LightMode" = "ForwardBase" "RenderType"="Transparent" "Queue"="Transparent" "ForceNoShadowCasting"="True"  }
			LOD 150
			Blend Zero SrcColor
			ZWrite Off
            ...
            fixed4 frag(v2f i) : COLOR {
                ...
                color = lerp(half4(1,1,1,1), _ShadowColor, (1.0 - attenuation) * _ShadowColor.a);
                return color;
            }
